...
export const clientDrafts = [
  {
    ...
    email: "olivia@summitventures.com",
    phone: "+1 555 0917",
...
export const dealTemplates: Record<
  DealStage,
  { title: string; amount: number; probability: number; closeInDays: number }
> = {
...
export const taskTemplates = [
  {
    title: "Review expansion brief for Quantum AI",
    client: "Lily Wang",
    dueInDays: 1,
